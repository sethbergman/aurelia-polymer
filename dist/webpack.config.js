...
module.exports = {
	...
	plugins: [
		...
		new ModuleDependenciesPlugin({
			"aurelia-dialog": ['./ai-dialog', './ai-dialog-header', './ai-dialog-body', './ai-dialog-footer', './attach-focus']
		}),
		new CopyPlugin([
			{
				from: 'index.html'
		...
		new BomPlugin(true),
		new ProvidePlugin({$: 'jquery', jQuery: 'jquery', "window.jQuery": 'jquery', Promise: 'bluebird'})
	]
};
